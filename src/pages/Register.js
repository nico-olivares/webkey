        ...
        <Container>
            <Form onSubmit={handleSubmit}>
                <Form.Group>
                    ...
                    <Form.Control id="username" name="username" type="text" onChange={handleUser} value={newUser.username} />
                </Form.Group>


                <Form.Group>
                    <Form.Label htmlFor="password">Password</Form.Label>
                    <Form.Control id="password" name="Password" type="text" onChange={handlePassword} />
                </Form.Group>

                <Form.Group>
                    <Form.Label htmlFor="confirm-password">Confirm Password</Form.Label>
                    <Form.Control id="password" name="Password" type="text" onChange={handlePassword2} />
                </Form.Group>
